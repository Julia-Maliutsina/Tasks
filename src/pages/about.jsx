    ...
    <Box sx={styles.maxWidth}>
      ...
      <div style={styles.aboutBlock}>
        ...
        >
          ...
          to add images and audio to their notes. In order to make your notes
          more personalized, functions of choosing design of notes will be
          provided: fonts, colors, themes.
        </Typography>
      </div>
    </Box>
  </div>
